...
router.get('/events/:id/tickets/count', eventCalls.getTicketCount);
router.get('/events/:id/calculatewinner', eventCalls.calculateWinner);
router.get('/events/:id/iswinner/:userID', eventCalls.isWinner);
router.get('/events/:id/wipetickets', eventCalls.removeTickets);
router.get('/events/:id/name', eventCalls.getName);
router.get('/events/:id/price', eventCalls.getPrice);
